...
export function ServiceCard({ id, name, description, image, navigate, addToCart} : { id : number, name : string, description : string, image : string, navigate : any, addToCart : any}) {
    return (
